                ...
                <div class="card-box">
                    <div class="widget-chart text-center">
                        <div style="height: auto;">
                            <img src="assets/images/test-isihira/test9.jpg" style="width: 260px;">
                        </div>
                        <h4>Tuliskan Apa Yang Anda Lihat <br> Jika Tidak Ada Tekan Tombol Tidak Ada</h4>
                        <form action="test-ishihara-proses.php" method="POST" name="test9">
                            <center>
                                <input type="text" class="form-control" style="width: 250px;" placeholder="Ketik Disini" name="jawaban9" autofocus>
                            ...
                            <ul class="list-inline chart-detail-list m-t-10">
                                <li>
                                    <button type="submit" class="btn btn-primary btn-rounded w-md waves-effect waves-light m-b-5" name="kirim9">OK</button>
                                </li>
                                <li>
                                    <button type="submit" class="btn btn-danger btn-rounded w-md waves-effect waves-light m-b-5" name="salah9">Tidak Ada</button>
                                </li>
                            </ul>
                        </form>
                    </div>
