        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h2>Sistem Diagnosa Buta Warna</h2><br>
                            <h4>Sistem dibuat untuk memenuhi persyaratan kelulusan tugas akhir.</h4><br>
                            <h4><b>Fatta Tentri Somantri</b> - <b>361363009</b></h4>
                        </div>
                    </div><!-- end col -->
